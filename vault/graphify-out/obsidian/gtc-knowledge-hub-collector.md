...
type: "document"
community: "Repository Pattern & Sources"
location: "Header table; Section 1 diagram; Section 7"
tags:
  - graphify/document
  - graphify/EXTRACTED
  - community/Repository_Pattern__Sources
---

# gtc-knowledge-hub-collector

## Connections
- [[ADR 0005 SQLAlchemy behind a repository]] - `conceptually_related_to` [INFERRED]
- [[ADR 0013 Wiki.js as a source route]] - `references` [EXTRACTED]
- [[Groundwork (shared vocabulary)]] - `references` [EXTRACTED]
- [[Postgres (shared Knowledge Base instance)]] - `references` [EXTRACTED]
- [[gtc-knowledge-hub-agent]] - `shares_data_with` [EXTRACTED]
- [[redaction_log]] - `references` [EXTRACTED]

#graphify/document #graphify/EXTRACTED #community/Repository_Pattern__Sources